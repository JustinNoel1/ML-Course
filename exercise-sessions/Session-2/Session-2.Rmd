...
btree.fit = xgb.train(data = matdata, label = hr_train$left, max.depth = 5, eval.metric="error", nrounds = 200, watchlist = watchlist)
```
...
That brings our accuracy up to 98.46%. This is something to write home about.